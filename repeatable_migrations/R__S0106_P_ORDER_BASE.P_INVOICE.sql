...
BEGIN
   INSERT INTO T_INVOICE (
    ...
    SELECT 
        ...
        V_SALES_ORDER_HDR.TOTAL_AMOUNT * 0.09 AS TAX_AMOUNT,
        V_SALES_ORDER_HDR.TOTAL_AMOUNT,
        V_SALES_ORDER_HDR.DISCOUNT,
        (V_SALES_ORDER_HDR.TOTAL_AMOUNT + (V_SALES_ORDER_HDR.TOTAL_AMOUNT * 0.09)) - V_SALES_ORDER_HDR.DISCOUNT AS FINAL_INVOICE_AMT,
